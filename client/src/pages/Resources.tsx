          ...
          <CardContent>
            <div className="space-y-6">
              {teamMembers.map((member, i) => (
                <div key={i} data-testid={`team-member-${i}`}>
          ...
          <CardContent>
            <div className="space-y-4">
              {projectProfitability.map((project, i) => (
                <div key={i} className="p-4 rounded-lg border border-card-border hover-elevate" data-testid={`profitability-${i}`}>
                  <div className="flex items-center justify-between mb-3">
                    <div>
                  ...
                  <div className="grid grid-cols-4 gap-4">
                    ...
                    <div>
                      ...
                      <div className="font-medium text-chart-3">{project.revenue}</div>
                    </div>
                  </div>
                </div>
              ))}
